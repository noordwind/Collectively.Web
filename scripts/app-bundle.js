define('app',['exports', 'resources/middleware/pre-login-route', 'resources/middleware/authorize-step', 'resources/app-config', 'resources/routes'], function (exports, _preLoginRoute, _authorizeStep, _appConfig, _routes) {
    'use strict';
    ...
    var _preLoginRoute2 = _interopRequireDefault(_preLoginRoute);
    ...
    var App = exports.App = function () {
        ...
        App.prototype.configureRouter = function configureRouter(config, router) {
            ...
            config.addPipelineStep('authorize', _preLoginRoute2.default);
...
define('resources/app-config',['exports'], function (exports) {
    'use strict';
...
define('resources/routes',['exports'], function (exports) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  var modulePrefix = 'resources/features';
...
define('resources/middleware/authorize-step',['exports', 'aurelia-framework', 'aurelia-router', 'resources/services/auth-service'], function (exports, _aureliaFramework, _aureliaRouter, _authService) {
    'use strict';
    ...
    var AuthorizeStep = (_dec = (0, _aureliaFramework.inject)(_authService2.default), _dec(_class = function () {
        ...
        AuthorizeStep.prototype.run = function run(navigationInstruction, next) {
            if (navigationInstruction.getAllInstructions().some(function (i) {
                return i.config.settings && i.config.settings.reqLogin;
            })) {
...
define('resources/middleware/pre-login-route',['exports'], function (exports) {
    'use strict';
    ...
    var PreLoginRoute = function () {
        function PreLoginRoute() {
            _classCallCheck(this, PreLoginRoute);
        }

        PreLoginRoute.prototype.run = function run(routingContext, next) {
            var skipRoutes = ['login'];
    ...
    exports.default = PreLoginRoute;
});
define('resources/services/api-base-service',['exports', 'aurelia-framework', 'whatwg-fetch', 'aurelia-fetch-client', 'resources/app-config', 'resources/services/auth-service'], function (exports, _aureliaFramework, _whatwgFetch, _aureliaFetchClient, _appConfig, _authService) {
    'use strict';
    ...
    var ApiBaseService = (_dec = (0, _aureliaFramework.inject)(_aureliaFetchClient.HttpClient, _authService2.default, _appConfig2.default), _dec(_class = function () {
        function ApiBaseService(http, authService, appConfig) {
            ...
            this.http.configure(function (config) {
                config.withBaseUrl(appConfig.apiUrl).withDefaults({
                    headers: {
                ...
                _this.baseCorsResponseHeaderNames = ['cache-control', 'content-type'];
            });
        }
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return this.http.fetch(path, { headers: this.getHeaders() });
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 9:
                                _ret = function () {
                                    var headers = {};
                                    for (var _iterator = response.headers, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
                                        var _ref3;
                                        ...
                                        if (!_this2.baseCorsResponseHeaderNames.includes(name)) {
                                            headers[name] = value;
                                        }
                                    }
                                    return {
        ...
        ApiBaseService.prototype.getHeaders = function getHeaders() {
...
define('resources/services/auth-service',['exports', 'aurelia-framework', 'resources/app-config'], function (exports, _aureliaFramework, _appConfig) {
    'use strict';
    ...
    var AuthService = (_dec = (0, _aureliaFramework.inject)(_appConfig2.default), _dec(_class = function () {
        ...
        AuthService.prototype.removeIdToken = function removeIdToken() {
            localStorage.removeItem(this.appConfig.idTokenStorageKey);
        };

        AuthService.prototype.removeAccessToken = function removeAccessToken() {
            localStorage.removeItem(this.appConfig.accessTokenStorageKey);
        };

        AuthService.prototype.removeProfile = function removeProfile() {
        ...
        AuthService.prototype.getAuth0Lock = function getAuth0Lock() {
            return new Auth0Lock(this.appConfig.auth0.token, this.appConfig.auth0.domain);
        };

        AuthService.prototype.authenticateViaAuth0 = function authenticateViaAuth0(lock, next) {
            var self = this;
...
define('resources/services/user-service',['exports', 'resources/services/api-base-service'], function (exports, _apiBaseService) {
    'use strict';
    ...
    var _apiBaseService2 = _interopRequireDefault(_apiBaseService);
    ...
    var UserService = function (_ApiBaseService) {
        _inherits(UserService, _ApiBaseService);

        function UserService() {
            _classCallCheck(this, UserService);

            return _possibleConstructorReturn(this, _ApiBaseService.apply(this, arguments));
        }
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return this.post('sign-in', { accessToken: accessToken });
        ...
        return UserService;
    }(_apiBaseService2.default);

    exports.default = UserService;
});
define('resources/features/account/login',['exports', 'aurelia-framework', 'resources/services/auth-service', 'resources/services/user-service', 'aurelia-router'], function (exports, _aureliaFramework, _authService, _userService, _aureliaRouter) {
    'use strict';
    ...
    var Login = exports.Login = (_dec = (0, _aureliaFramework.inject)(_authService2.default, _userService2.default, _aureliaRouter.Router), _dec(_class = function () {
        function Login(authService, userService, router) {
            ...
            authService.authenticateViaAuth0(this.lock, function (authResult, profile) {
                self.userService.signIn(authResult.accessToken).then(function (authResponse) {
                    self.redirectToDashboard();
                });
            });
        }

        Login.prototype.redirectToDashboard = function redirectToDashboard() {
            this.lock.hide();
...
define('resources/features/home/home',['exports', 'aurelia-framework', 'aurelia-router'], function (exports, _aureliaFramework, _aureliaRouter) {
    'use strict';
...
define('resources/features/nav/nav-bar',['exports', 'aurelia-framework', 'resources/services/auth-service'], function (exports, _aureliaFramework, _authService) {
    'use strict';
    ...
    var NavBar = exports.NavBar = (_dec = (0, _aureliaFramework.inject)(_authService2.default), _dec(_class = (_class2 = function () {
        ...
        _createClass(NavBar, [{
            ...
            get: function get() {
                ...
                for (var _iterator = this.router.navigation, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
                    ...
                    if (!(this.authService.isLoggedIn && navModel.settings.navHideAfterLogin || !this.authService.isLoggedIn && navModel.settings.reqLogin)) {
...
define('resources/features/remarks/remarks',['exports', 'aurelia-framework', 'aurelia-router'], function (exports, _aureliaFramework, _aureliaRouter) {
    'use strict';

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.Remarks = undefined;
    ...
    var Remarks = exports.Remarks = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router), _dec(_class = function () {
        function Remarks(router) {
            _classCallCheck(this, Remarks);

            this.router = router;
        }

        Remarks.prototype.activate = function () {
            var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
...
define('app.1',['exports', 'resources/middleware/pre-login-route', 'resources/middleware/authorize-step', 'resources/app-config', 'resources/routes'], function (exports, _preLoginRoute, _authorizeStep, _appConfig, _routes) {
    'use strict';
...
define('text!app.html', ['module'], function(module) { module.exports = "<template>\r\n    <require from=\"styles/app.css\"></require>\r\n    <require from=\"resources/features/nav/nav-bar\"></require>\r\n    <nav-bar router.bind=\"router\" if.bind=\"!router.currentInstruction.config.settings.hideNavbar\"></nav-bar>\r\n    <main>\r\n        <div class=\"container\">\r\n            <router-view></router-view>\r\n        </div>\r\n    </main>\r\n</template>\r\n"; });
define('text!styles/app.css', ['module'], function(module) { module.exports = "h1, h2, h3, h4 {\n  color: #E40521; }\n\nnav {\n  background-color: #E40521; }\n\n.side-nav a {\n  color: #E40521; }\n\n.side-nav i {\n  color: #E40521 !important; }\n\n.btn {\n  background-color: #E40521; }\n\n.btn:hover {\n  background-color: #FF1F3B; }\n\n.btn:active {\n  background-color: #FF1F3B; }\n\n.btn:focus {\n  background-color: #FF1F3B; }\n"; });
define('text!resources/features/account/login.html', ['module'], function(module) { module.exports = "<template>\r\n    <div class=\"container\">\r\n        <div class=\"row card-panel\">\r\n            <div class=\"col s12 center-align\">\r\n                <h3>Coolector</h3>\r\n                <img src=\"assets/images/noordwind.png\" />\r\n                <div class=\"clear\"></div>\r\n                <button click.delegate=\"login()\" class=\"btn btn-large waves-effect waves-light\"><i class=\"material-icons left\">input</i>Sign in</button>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</template>\r\n"; });
define('text!resources/features/home/home.html', ['module'], function(module) { module.exports = "<template>\r\n    <h2>Home</h2>\r\n</template>\r\n"; });
define('text!resources/features/nav/nav-bar.html', ['module'], function(module) { module.exports = "<template>\r\n    <nav role=\"navigation\" class=\"ft-nav\">\r\n        <div class=\"container\">\r\n            <a href=\"/\" class=\"brand-logo\">Coolector</a>\r\n            <a href=\"#\" data-activates=\"nav-mobile\" class=\"button-collapse right\">\r\n                <i class=\"material-icons\">menu</i>\r\n            </a>\r\n            <ul class=\"right hide-on-med-and-down\">\r\n                <li repeat.for=\"route of navigation\" class=\"${route.isActive ? 'active' : ''}\">\r\n                    <a class=\"waves-effect\" href.bind=\"route.href\">\r\n                        <i class=\"material-icons left\">${route.settings.icon}</i>\r\n                        <span>${route.title}</span>\r\n                    </a>\r\n                </li>\r\n                <li if.bind=\"authService.isLoggedIn\">\r\n                    <a class=\"waves-effect\"  href=\"#\" click.delegate=\"logout()\">\r\n                        <i class=\"material-icons left\">power_settings_new</i>\r\n                        <span>Logout</span>\r\n                    </a>\r\n                </li>\r\n            </ul>\r\n            <ul class=\"side-nav\" id=\"nav-mobile\">\r\n                <li repeat.for=\"route of navigation\" class=\"${route.isActive ? 'active' : ''}\">\r\n                    <a class=\"waves-effect\" href.bind=\"route.href\">\r\n                        <i class=\"material-icons\">${route.settings.icon}</i>\r\n                        ${route.title}\r\n                    </a>\r\n                </li>\r\n                <li><div class=\"divider\"></div></li>\r\n                <li if.bind=\"authService.isLoggedIn\">\r\n                    <a class=\"waves-effect\" href=\"#\" click.delegate=\"logout()\">\r\n                        <i class=\"material-icons\">power_settings_new</i>  \r\n                        Logout\r\n                    </a>\r\n                </li>\r\n            </ul>\r\n        </div>\r\n    </nav>\r\n</template>\r\n"; });
define('text!resources/features/remarks/remarks.html', ['module'], function(module) { module.exports = "<template>\r\n    <h2>Remarks</h2>\r\n</template>\r\n"; });
